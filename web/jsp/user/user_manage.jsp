                ...
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            String delete_user_url = "<form action='/DeleteUserServlet'  target='MyRight' method='get'>" +
                                    "<input type='hidden' name='userid' value="+userid+">" +
                                    "<input type='hidden' name='grade' value="+current_user.getUser_rights()+">" +
                                    "<input type='submit' value='删除该用户'></form>";
                        %>
                        <%=editor_user_url%>
                        <%=delete_user_url%>
                        <%--<a href=<%=editor_user_url%> target="MyRight"> Editor </a>--%>
                        <%--<a href="#" target="MyRight">delete</a>--%>
                    </td>
                </tr>
    <%
            }
...
<br/>
<%
    String left1 = "<form name='left' action='/leftServlet' target='MyRight' method='get'> "
            + "<input type='hidden' value='left1' id='left1_right1' name='left1_right1'>"
            + "<input type='submit' value='上一页' id='bt1'></form>";
    String right1 = "<form name='right' action='/leftServlet' target='MyRight' method='get'> "
